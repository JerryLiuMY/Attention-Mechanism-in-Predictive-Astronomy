...
class LSTMDataProcessor:
    ...
    def __init__(self):
        ...
        # self.prepare_standard_lstm_data()
    ...
    def prepare_standard_lstm_data(self):
        for crts_id in self.crts_list:
            ...
            X_train, y_train = self.create_X_y(scaled_mag_list_train, scaled_delta_t_list_train)
            X_cross, y_cross = self.create_X_y(scaled_mag_list_cross, scaled_delta_t_list_cross)
            X_test, y_test = self.create_X_y(scaled_mag_list_test, scaled_delta_t_list_test)
