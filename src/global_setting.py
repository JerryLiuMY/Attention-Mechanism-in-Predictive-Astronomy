...
# phased_lstm_data
phased_lstm_data_path = os.path.join(DATA_FOLDER, 'processed_data', 'phased_lstm')

# ----------------------------------- Model Information -----------------------------------
# standard_lstm_model
standard_lstm_model_path = os.path.join(DATA_FOLDER, 'model', 'standard_lstm')

# phased_lstm_model
phased_lstm_model_path = os.path.join(DATA_FOLDER, 'model', 'phased_lstm')
